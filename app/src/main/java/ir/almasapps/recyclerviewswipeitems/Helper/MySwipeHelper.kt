...
abstract class MySwipeHelper(context: Context, private val recyclerView: RecyclerView, internal val buttonWidth:Int):ItemTouchHelper.SimpleCallback(0,ItemTouchHelper.LEFT) {
